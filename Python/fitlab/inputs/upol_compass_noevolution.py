...
conf['params']['pdf']={}
conf['params']['pdf']['widths0 valence']  = {'value':<<    1.51299461675532387339e+00>>,'fixed':False,'min':0,'max':10}
conf['params']['pdf']['widths0 sea']      = {'value':<<    1.89320192075475546289e+01>>,'fixed':False,'min':0,'max':10}

conf['params']['ff']={}
conf['params']['ff']['widths0 pi+ fav']   = {'value':<<    1.20734236802583022596e-01>>,'fixed':False,'min':0,'max':1}
conf['params']['ff']['widths0 pi+ unfav'] = {'value':<<    1.08044254526844671349e-01>>,'fixed':False,'min':0,'max':1}
...
conf['datasets']['sidis']['filters'][0]['filter']="z<0.9 and Q2>1.69" #npts    = 3572 chi2    = 5627.819758
