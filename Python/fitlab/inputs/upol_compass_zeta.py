...
conf['params']['pdf']={}
conf['params']['pdf']['widths0 valence']  = {'value':<<    1.13256500669889348387e-01>>,'fixed':False,'min':0,'max':10}
conf['params']['pdf']['widths0 sea']      = {'value':<<    1.00000000000000000000e+01>>,'fixed':False,'min':0,'max':10}

conf['params']['ff']={}
conf['params']['ff']['widths0 pi+ fav']   = {'value':<<    7.74801892526301161368e-02>>,'fixed':False,'min':0,'max':1}
conf['params']['ff']['widths0 pi+ unfav'] = {'value':<<    1.95293161333082165854e-02>>,'fixed':False,'min':0,'max':1}
...
conf['params']['gk']={}
conf['params']['gk']['g2']   = {'value':<<    7.52049814695271656717e-01>>,'fixed':False,'min':0,'max':10}
...
conf['datasets']['sidis']['filters'][0]['filter']="z<0.9 and Q2>1.69" # 
