...
conf['params']['pdf']={}
conf['params']['pdf']['widths0 valence']  = {'value':<<    2.57968243213211823051e-01>>,'fixed':False,'min':0,'max':10}
conf['params']['pdf']['widths0 sea']      = {'value':<<    1.21560640226595965208e-06>>,'fixed':False,'min':0,'max':10}

conf['params']['ff']={}
conf['params']['ff']['widths0 pi+ fav']   = {'value':<<    1.51854556368094445462e-01>>,'fixed':False,'min':0,'max':1}
conf['params']['ff']['widths0 pi+ unfav'] = {'value':<<    1.72039597125147575296e-01>>,'fixed':False,'min':0,'max':1}
...
conf['datasets']['sidis']['filters'][0]['filter']="z<0.9 and Q2>1.69 and pT>0.15 and pT<1.1"
#conf['datasets']['sidis']['filters'][0]['filter']="z<0.6 and Q2>1.69 and (pT/z)**2<0.25*Q2 and yp-yh>0."
